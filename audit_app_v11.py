...
td = TabDescriptions()
st.set_page_config(page_title="Audit AI v11.0 — Midnight Audit", page_icon="🛡️", layout="wide")
...
with st.sidebar:
    ...
    <div style="text-align:center; padding:12px 0 20px;">
        ...
        <p style="color:rgba(255,255,255,0.35); font-size:10px; margin:0; letter-spacing:1.5px; text-transform:uppercase;">v11.0 · Midnight Audit</p>
    </div>
    """, unsafe_allow_html=True)
    page = st.radio("Цэс:", [
